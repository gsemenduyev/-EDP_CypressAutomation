...
public class SchedulingPage {
    ...
    public void sendKeysScheduleGrossRateCell(String text){
        actions.moveToElement(getNewStationButton(), 100, 80).doubleClick().sendKeys(Keys.chord(Keys.CONTROL,"a",Keys.DELETE),text).build().perform();
    }

    public void sendKeysScheduleFirstWeekCell(String text){
        actions.moveToElement(getNewStationButton(), 520, 80).doubleClick().sendKeys(Keys.chord(Keys.CONTROL,"a",Keys.DELETE),text).build().perform();
    }

    public void sendKeysScheduleSecondWeekCell(String text){
        actions.moveToElement(getNewStationButton(), 550, 80).doubleClick().sendKeys(Keys.chord(Keys.CONTROL,"a",Keys.DELETE),text).build().perform();
    }
